...
STATIC_URL = 'static/'
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'static'), ] # build a path for our subdirectory static so we can link to files in the static directory from a template. 
